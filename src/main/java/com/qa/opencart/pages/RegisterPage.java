...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName, 
		...
		eleUtil.waitForElementVisible(this.firstName, AppConstants.DEFAULT_SHORT_TIME_OUT).sendKeys(firstName);//wait for the element visible on the page
		...
		System.out.println("user reg success messg : " + successMesg);
			...
			if(successMesg.contains(AppConstants.USER_REG_SUCCESS_MESSG)) {
				//click on logout and register so we can create more users from the excel file
