...
public class AccountsPageTest extends BaseTest {
	...
	public void searchProductTest(String searchKey, String productName) {
		searchPage = accPage.performSearch(searchKey); //MacBook
		if(searchPage.getSearchProductsCount()>0) {
			productInfoPage = searchPage.selectProduct(productName);//MacBook Pro--> lending on productInfoPage
	...
	//Login-->AccountPage-->SearchPage-->ProductInfoPage= 4 level page chaining(Zigzag pattern)
